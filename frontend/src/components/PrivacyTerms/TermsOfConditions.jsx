...
const TermsOfConditions = () => {
    ...
    return (
        <div className='privacy-terms-container'>
            ...
            <p className='update'>Last updated: June 21, 2024</p>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to CampusNav.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to CampusNav, accessible from <a href="https://www.campusnav.com" rel="external nofollow noopener" target="_blank">https://www.campusnav.com</a></p>
            </li>
            <li>
            ...
            <ul>
            <li>By visiting this page on our website: <a onClick={() => handleNavigation('/contact')}>{t('contact')}</a></li>
            </ul>
        </div>
    );
}
